...
public class TestStorageActivity extends Activity {
    private static final String EXTRA_ADB_AUTO_LAUNCH = "adb_auto_launch";
    private static final String EXTRA_ADB_INSTANCE_ROOT = "adb_instance_root";
    ...
    private void exit() {
        ...
        if(extras != null) {
            String instanceRoot = extras.getString(EXTRA_ADB_INSTANCE_ROOT);
            if(Tools.isValidString(instanceRoot)) {
                LauncherPreferences.DEFAULT_PREF.edit()
                        .putString(LauncherPreferences.PREF_KEY_CURRENT_INSTANCE, instanceRoot)
                        .apply();
            }
        }
